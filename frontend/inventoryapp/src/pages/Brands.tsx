...
const handleDelete = (id:number) => {console.log(id);};
  ...
  const handleSubmit = async () => {
   ...
   try {
    ...
    showSuccess('Brand created succesfully.');
    handleClose(); 
...
//   }
  return (
    <Box sx={{ height: '100%', width: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Create Dialog */}     
      <FormDialog open={createOpen} onClose={handleClose} title='Add New Brand' submitLabel='Save' onSubmit={handleSubmit} isSubmitting={createLoading}>
        <SingleFormFields label='Brand Name' name={brName}  onNameChange={setBrName} />
      </FormDialog>
