...
const handleAddSubmit = () => {
  ...
  apiClient.post('/brands', {br_Name: brandName})
  .then((res) => {
    const newBrand = {
      id: res.data.id,
      br_Name: brandName
...
const handleEditSubmit = () => {
  ...
  setIsSubmitting(true);
  apiClient.put(`/brands/${editingBrandId}`, { br_Name: brandName })
    .then(() => {
...
const handleSubmit = () => {
  ...
  const confirmDelete = async () => {
    ...
    apiClient.delete(`brands/${selectedDeleteId}`)
    .then(() => {
    ...
    const dialogTitle = mode === 'add' ? 'Add New Brand' : mode === 'edit' ? 'Edit Brand' : 'View Brand';
